...
export const UPDATE_PLAYER_PICTURE_URI = `${PLAYER_BASE_URI}/update-picture`;
export const DELETE_PLAYER_PICTURE_URI = `${PLAYER_BASE_URI}/picture`;
export const DELETE_PLAYER_URI = PLAYER_BASE_URI;
export const GET_PLAYER_DETAILS_URI = `${PLAYER_BASE_URI}/details`;
...
export const GET_APP_CONFIG_URI = `/config`;
